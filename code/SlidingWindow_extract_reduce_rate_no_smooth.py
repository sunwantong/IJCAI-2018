...
def load_data_one():
    ...
    train_feature_range5, train_label_range5, \
    train_feature_range6, train_label_range6, \
    train_feature_range7, train_label_range7, \
    train_feature_range8, train_label_range8, \
    train_feature_range9, train_label_range9, \
    validate_feature_range, validate_label_range, \
    test_feature_range, test_label_range = huachuang_method_del_06_1dot5(dframe, dframe_test)
...
#4.5 day feature range
def huachuang_method(dframe, dframe_test):
    # 训练1
    train_feature_range1 = dframe[(dframe['context_timestamp'] >= '20180831000000') &
                                  (dframe['context_timestamp'] <= '20180904115959')]
    train_label_range1 = dframe[(dframe['context_timestamp'] >= '20180904120000') &
                                (dframe['context_timestamp'] <= '20180904235959')]
    # 训练2
    train_feature_range2 = dframe[(dframe['context_timestamp'] >= '20180831120000') &
                                  (dframe['context_timestamp'] <= '20180904235954')]
    train_label_range2 = dframe[(dframe['context_timestamp'] >= '20180905000000') &
                                (dframe['context_timestamp'] <= '20180905115959')]
    # 训练3
    train_feature_range3 = dframe[(dframe['context_timestamp'] >= '20180901000000') &
                                  (dframe['context_timestamp'] <= '20180905115959')]
    train_label_range3 = dframe[(dframe['context_timestamp'] >= '20180905120000') &
                                (dframe['context_timestamp'] <= '20180905235959')]
    # 训练4
    train_feature_range4 = dframe[(dframe['context_timestamp'] >= '20180901120000') &
                                  (dframe['context_timestamp'] <= '20180905235959')]
    train_label_range4 = dframe[(dframe['context_timestamp'] >= '20180906000000') &
                                (dframe['context_timestamp'] <= '20180906115959')]
    # 训练5
    train_feature_range5 = dframe[(dframe['context_timestamp'] >= '20180902000000') &
                                  (dframe['context_timestamp'] <= '20180906115959')]
    train_label_range5 = dframe[(dframe['context_timestamp'] >= '20180906120000') &
                                (dframe['context_timestamp'] <= '20180906235959')]
    # 验证
    validate_feature_range = dframe[(dframe['context_timestamp'] >= '20180902120000') &
                                    (dframe['context_timestamp'] <= '20180906235959')]
    validate_label_range = dframe[(dframe['context_timestamp'] >= '20180907000000') &
                                  (dframe['context_timestamp'] <= '20180907115959')]
    # 测试
    test_feature_range = dframe[(dframe['context_timestamp'] >= '20180903000000') &
                                (dframe['context_timestamp'] <= '20180907115959')]
...
#3.5 day feature range
def huachuang_method_seven(dframe, dframe_test):
    # 训练1
    train_feature_range1 = dframe[(dframe['context_timestamp'] >= '20180831000000') &
                                  (dframe['context_timestamp'] <= '20180903115959')]
    train_label_range1 = dframe[(dframe['context_timestamp'] >= '20180903120000') &
                                (dframe['context_timestamp'] <= '20180903235959')]
    # 训练2
    train_feature_range2 = dframe[(dframe['context_timestamp'] >= '20180831120000') &
                                  (dframe['context_timestamp'] <= '20180903235954')]
    train_label_range2 = dframe[(dframe['context_timestamp'] >= '20180904000000') &
                                (dframe['context_timestamp'] <= '20180904115959')]
    # 训练3
    train_feature_range3 = dframe[(dframe['context_timestamp'] >= '20180901000000') &
                                  (dframe['context_timestamp'] <= '20180904115959')]
    train_label_range3 = dframe[(dframe['context_timestamp'] >= '20180904120000') &
                                (dframe['context_timestamp'] <= '20180904235959')]
    # 训练4
    train_feature_range4 = dframe[(dframe['context_timestamp'] >= '20180901120000') &
                                  (dframe['context_timestamp'] <= '20180904235959')]
    train_label_range4 = dframe[(dframe['context_timestamp'] >= '20180905000000') &
                                (dframe['context_timestamp'] <= '20180905115959')]

    # 训练5
    train_feature_range5 = dframe[(dframe['context_timestamp'] >= '20180902000000') &
                                  (dframe['context_timestamp'] <= '20180905115959')]
    train_label_range5 = dframe[(dframe['context_timestamp'] >= '20180905120000') &
                                (dframe['context_timestamp'] <= '20180905235959')]

    # 训练6
    train_feature_range6 = dframe[(dframe['context_timestamp'] >= '20180902120000') &
                                  (dframe['context_timestamp'] <= '20180905235959')]
    train_label_range6 = dframe[(dframe['context_timestamp'] >= '20180906000000') &
                                (dframe['context_timestamp'] <= '20180906115959')]

    # 训练7
    train_feature_range7 = dframe[(dframe['context_timestamp'] >= '20180903000000') &
                                  (dframe['context_timestamp'] <= '20180906115959')]
    train_label_range7 = dframe[(dframe['context_timestamp'] >= '20180906120000') &
                                (dframe['context_timestamp'] <= '20180906235959')]

    # 验证
    validate_feature_range = dframe[(dframe['context_timestamp'] >= '20180903120000') &
                                    (dframe['context_timestamp'] <= '20180906235959')]
    validate_label_range = dframe[(dframe['context_timestamp'] >= '20180907000000') &
                                  (dframe['context_timestamp'] <= '20180907115959')]

    # 测试
    test_feature_range = dframe[(dframe['context_timestamp'] >= '20180904000000') &
                                (dframe['context_timestamp'] <= '20180907115959')]
    test_label_range = dframe_test
...
#del 06 all day
def huachuang_method_del_06(dframe, dframe_test):
    # 训练1
    train_feature_range1 = dframe[(dframe['context_timestamp'] >= '20180831000000') &
                                  (dframe['context_timestamp'] <= '20180902115959')]
    train_label_range1 = dframe[(dframe['context_timestamp'] >= '20180902120000') &
                                (dframe['context_timestamp'] <= '20180902235959')]
    # 训练2
    train_feature_range2 = dframe[(dframe['context_timestamp'] >= '20180831120000') &
                                  (dframe['context_timestamp'] <= '20180902235954')]
    train_label_range2 = dframe[(dframe['context_timestamp'] >= '20180903000000') &
                                (dframe['context_timestamp'] <= '20180903115959')]
    # 训练3
    train_feature_range3 = dframe[(dframe['context_timestamp'] >= '20180901000000') &
                                  (dframe['context_timestamp'] <= '20180903115959')]
    train_label_range3 = dframe[(dframe['context_timestamp'] >= '20180903120000') &
                                (dframe['context_timestamp'] <= '20180903235959')]
    # 训练4
    train_feature_range4 = dframe[(dframe['context_timestamp'] >= '20180901120000') &
                                  (dframe['context_timestamp'] <= '20180903235959')]
    train_label_range4 = dframe[(dframe['context_timestamp'] >= '20180904000000') &
                                (dframe['context_timestamp'] <= '20180904115959')]

    # 训练5
    train_feature_range5 = dframe[(dframe['context_timestamp'] >= '20180902000000') &
                                  (dframe['context_timestamp'] <= '20180904115959')]
    train_label_range5 = dframe[(dframe['context_timestamp'] >= '20180904120000') &
                                (dframe['context_timestamp'] <= '20180904235959')]

    # 训练6
    train_feature_range6 = dframe[(dframe['context_timestamp'] >= '20180902120000') &
                                  (dframe['context_timestamp'] <= '20180904235959')]
    train_label_range6 = dframe[(dframe['context_timestamp'] >= '20180905000000') &
                                (dframe['context_timestamp'] <= '20180905115959')]

    # 训练7
    train_feature_range7 = dframe[(dframe['context_timestamp'] >= '20180903000000') &
                                  (dframe['context_timestamp'] <= '20180905115959')]
    train_label_range7 = dframe[(dframe['context_timestamp'] >= '20180905120000') &
                                (dframe['context_timestamp'] <= '20180905235959')]
    ...
    test_feature_range = dframe[(dframe['context_timestamp'] >= '20180904000000') &
                                (dframe['context_timestamp'] <= '20180905235959')]
    test_feature_range1 = dframe[(dframe['context_timestamp'] >= '20180907000000') &
                                 (dframe['context_timestamp'] <= '20180907115959')]
    test_feature_range = test_feature_range.append(test_feature_range1)
...
#del 06 afternoon
def huachuang_method_del_06after(dframe, dframe_test):
    # 训练1
    train_feature_range1 = dframe[(dframe['context_timestamp'] >= '20180831000000') &
                                  (dframe['context_timestamp'] <= '20180902115959')]
    train_label_range1 = dframe[(dframe['context_timestamp'] >= '20180902120000') &
    ...
    # 训练8
    train_feature_range8 = dframe[(dframe['context_timestamp'] >= '20180903120000') &
                                  (dframe['context_timestamp'] <= '20180905235959')]
    train_label_range8 = dframe[(dframe['context_timestamp'] >= '20180906000000') &
                                (dframe['context_timestamp'] <= '20180906115959')]

    # 验证
    validate_feature_range = dframe[(dframe['context_timestamp'] >= '20180904000000') &
                                    (dframe['context_timestamp'] <= '20180906115959')]
...
#del 06 all day but feature range is 1.5days
def huachuang_method_del_06_1dot5(dframe, dframe_test):

    # 训练1
    train_feature_range1 = dframe[(dframe['context_timestamp'] >= '20180831000000') &
                                  (dframe['context_timestamp'] <= '20180901115959')]
    train_label_range1 = dframe[(dframe['context_timestamp'] >= '20180901120000') &
                                (dframe['context_timestamp'] <= '20180901235959')]
    # 训练2
    train_feature_range2 = dframe[(dframe['context_timestamp'] >= '20180831120000') &
                                  (dframe['context_timestamp'] <= '20180901235959')]
    train_label_range2 = dframe[(dframe['context_timestamp'] >= '20180902000000') &
                                (dframe['context_timestamp'] <= '20180902115959')]
    # 训练3
    train_feature_range3 = dframe[(dframe['context_timestamp'] >= '20180901000000') &
                                  (dframe['context_timestamp'] <= '20180902115959')]
    train_label_range3 = dframe[(dframe['context_timestamp'] >= '20180902120000') &
                                (dframe['context_timestamp'] <= '20180902235959')]
    # 训练4
    train_feature_range4 = dframe[(dframe['context_timestamp'] >= '20180901120000') &
                                  (dframe['context_timestamp'] <= '20180902235959')]
    train_label_range4 = dframe[(dframe['context_timestamp'] >= '20180903000000') &
                                (dframe['context_timestamp'] <= '20180903115959')]

    # 训练5
    train_feature_range5 = dframe[(dframe['context_timestamp'] >= '20180902000000') &
                                  (dframe['context_timestamp'] <= '20180903115959')]
    train_label_range5 = dframe[(dframe['context_timestamp'] >= '20180903120000') &
                                (dframe['context_timestamp'] <= '20180903235959')]

    # 训练6
    train_feature_range6 = dframe[(dframe['context_timestamp'] >= '20180902120000') &
                                  (dframe['context_timestamp'] <= '20180903235959')]
    train_label_range6 = dframe[(dframe['context_timestamp'] >= '20180904000000') &
                                (dframe['context_timestamp'] <= '20180904115959')]

    # 训练7
    train_feature_range7 = dframe[(dframe['context_timestamp'] >= '20180903000000') &
                                  (dframe['context_timestamp'] <= '20180904115959')]
    train_label_range7 = dframe[(dframe['context_timestamp'] >= '20180904120000') &
                                (dframe['context_timestamp'] <= '20180904235959')]

    # 训练8
    train_feature_range8 = dframe[(dframe['context_timestamp'] >= '20180903120000') &
                                  (dframe['context_timestamp'] <= '20180904235959')]
    train_label_range8 = dframe[(dframe['context_timestamp'] >= '20180905000000') &
                                (dframe['context_timestamp'] <= '20180905115959')]

    # 训练9
    train_feature_range9 = dframe[(dframe['context_timestamp'] >= '20180904000000') &
                                  (dframe['context_timestamp'] <= '20180905115959')]
    train_label_range9 = dframe[(dframe['context_timestamp'] >= '20180905120000') &
                                (dframe['context_timestamp'] <= '20180905235959')]

    # 验证
    validate_feature_range = dframe[(dframe['context_timestamp'] >= '20180904120000') &
                                    (dframe['context_timestamp'] <= '20180905235959')]
    ...
    # 测试
    test_feature_range = dframe[(dframe['context_timestamp'] >= '20180905000000') &
                                (dframe['context_timestamp'] <= '20180905235959')]
...
# 贝叶斯平滑
def rank_save(df_rank,flag):
    path = 'rank_data/file'+str(flag)+'.pkl'
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        return rank
    else:
        pickle.dump(df_rank,open(path,'wb'))
...
def stat_feature_count(data_label,data,key,value,feature_name):
    ...
    ftrain = pd.merge(data_label, feature, on="shop_id", how="left")
    return ftrain
...
def extract_train_feature(train_feature_range,train_label_range,flag):
    ...
    # ftrain = stat_feature_count(train_label_range,d1,['shop_id'],'item_sales_level','shop_count')
    ...
    #交易率
    ftrain['user_istrade_rate'] = (ftrain['user_count_istrade'].astype('float') + 0.00001) / (ftrain['user_count'].astype('float') + 0.001)
    ...
    # 交易率
    ftrain['user_item_count_istrade_rate'] = (ftrain['user_item_count_istrade'].astype('float') + 0.00001) / (ftrain['user_item_count'].astype('float') + 0.001)
    ...
    ftrain['item_istrade_rate'] = (ftrain.item_count_istrade.astype('float') + 0.00001) / (ftrain.item_count.astype('float') + 0.001)
    ...
    ftrain['shop_istrade_rate'] = (ftrain.shop_count_istrade.astype('float') + 0.00001) / (ftrain.shop_count.astype('float') + 0.001)
    ...
    ftrain['user_shop_count_istrade_rate'] = (ftrain.user_shop_count_istrade.astype('float') + 0.00001) / (ftrain.user_shop_count.astype('float') + 0.001)
    ...
    ftrain['user_shop_item_count_istrade_rate'] = (ftrain.user_shop_item_count_istrade.astype('float') + 0.00001) / (ftrain.user_shop_item_count.astype('float') + 0.001)
    ...
    ftrain['user_item_item_city_id_count_istrade_rate'] = (ftrain.user_item_item_city_id_count_istrade.astype('float') + 0.00001) / (ftrain.user_item_item_city_id_count.astype('float') + 0.001)
    ...
    ftrain['user_category_count_istrade_rate'] = (ftrain.user_category_count_istrade.astype('float') + 0.00001) / (ftrain.user_category_count.astype('float') + 0.001)
    # #  贝叶斯平滑
    ...
    ftrain['user_gender_id_count_istrade_rate'] = (ftrain.user_gender_id_count_istrade.astype('float') + 0.00001) / (ftrain.user_gender_id_count.astype('float') + 0.001)
    ...
    ftrain['user_occupation_id_count_istrade_rate'] = (ftrain.user_occupation_id_count_istrade.astype('float') + 0.00001) / (ftrain.user_occupation_id_count.astype('float') + 0.001)
    ...
    ftrain['user_age_level_count_istrade_rate'] = (ftrain.user_age_level_count_istrade.astype('float') + 0.00001) / (ftrain.user_age_level_count.astype('float') + 0.001)
    ...
    ftrain['item_sales_level_count_istrade_rate'] = (ftrain.item_sales_level_count_istrade.astype('float') + 0.00001) / (ftrain.item_sales_level_count.astype('float') + 0.001)
    ...
    ftrain['item_collected_level_count_istrade_rate'] = (ftrain.item_collected_level_count_istrade.astype('float') + 0.00001) / (ftrain.item_collected_count.astype('float') + 0.001)
    ...
    ftrain['user_star_level_count_istrade_rate'] = (ftrain.user_star_level_count_istrade.astype('float') + 0.00001) / (ftrain.user_star_level_count.astype('float') + 0.001)
    ...
    ftrain['item_pv_level_count_istrade_rate'] = (ftrain.item_pv_level_count_istrade.astype('float') + 0.00001) / (ftrain.item_pv_level_count.astype('float') + 0.001)
    ...
    ftrain['shop_review_num_level_count_istrade_rate'] = (ftrain.shop_review_num_level_count_istrade.astype('float') + 0.00001) / (ftrain.shop_review_num_level_count.astype('float') + 0.001)
    ...
    ftrain['item_price_level_count_istrade_rate'] = (ftrain.item_price_level_count_istrade.astype('float') + 0.00001) / (ftrain.item_price_level_count.astype('float') + 0.001)
    # #  贝叶斯平滑
    ...
    标签区间提取特征
    """
    ftrain = get_train_label(ftrain, train_label_range,flag)
    print("训练集标签区间结束!")
    return ftrain


def get_train_label(ftrain, train_label_range,flag):
    i = 0
    # 商铺出现的次数
    ...
    i += 1
    path = '../rank_data/file' + str(i) + flag + '.pkl'
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
...
def extract_validate_feature(validate_feature_range,validate_label_range):
    ...
    fvalidate['user_istrade_rate'] = (fvalidate['user_count_istrade'].astype('float') + 0.00001) / (fvalidate['user_count'].astype('float') + 0.001)
    ...
    # 交易率
    fvalidate['user_item_count_istrade_rate'] = (fvalidate['user_item_count_istrade'].astype('float') + 0.00001) / (fvalidate['user_item_count'].astype('float') + 0.001)
    ...
    fvalidate['item_istrade_rate'] = (fvalidate.item_count_istrade.astype('float') + 0.00001) / (fvalidate.item_count.astype('float') + 0.001)
    ...
    fvalidate['shop_istrade_rate'] = (fvalidate.shop_count_istrade.astype('float') + 0.00001) / (fvalidate.shop_count.astype('float') + 0.001)
    ...
    fvalidate['user_shop_count_istrade_rate'] = (fvalidate.user_shop_count_istrade.astype('float') + 0.00001) / (fvalidate.user_shop_count.astype('float') + 0.001)
    #
    # # # 贝叶斯平滑
    ...
    fvalidate['user_shop_item_count_istrade_rate'] = (fvalidate.user_shop_item_count_istrade.astype('float') + 0.00001) / (fvalidate.user_shop_item_count.astype('float') + 0.001)
    # # # 贝叶斯平滑
    ...
    fvalidate['user_item_item_city_id_count_istrade_rate'] = (fvalidate.user_item_item_city_id_count_istrade.astype('float') + 0.00001) / (fvalidate.user_item_item_city_id_count.astype('float') + 0.001)
    # #  贝叶斯平滑
    ...
    fvalidate['user_category_count_istrade_rate'] = (fvalidate.user_category_count_istrade.astype('float') + 0.00001) / (fvalidate.user_category_count.astype('float') + 0.001)
    # #  贝叶斯平滑
    ...
    fvalidate['user_gender_id_count_istrade_rate'] = (fvalidate.user_gender_id_count_istrade.astype('float') + 0.00001) / (fvalidate.user_gender_id_count.astype('float') + 0.001)
    ...
    fvalidate['user_occupation_id_count_istrade_rate'] = (fvalidate.user_occupation_id_count_istrade.astype('float') + 0.00001) / (fvalidate.user_occupation_id_count.astype('float') + 0.001)
    ...
    fvalidate['user_age_level_count_istrade_rate'] = (fvalidate.user_age_level_count_istrade.astype('float') + 0.00001) / (fvalidate.user_age_level_count.astype('float') + 0.001)
    ...
    fvalidate['item_sales_level_count_istrade_rate'] = (fvalidate.item_sales_level_count_istrade.astype('float') + 0.00001) / (fvalidate.item_sales_level_count.astype('float') + 0.001)
    ...
    fvalidate['item_collected_level_count_istrade_rate'] = (fvalidate.item_collected_level_count_istrade.astype('float') + 0.00001) / (fvalidate.item_collected_count.astype('float') + 0.001)
    ...
    fvalidate['user_star_level_count_istrade_rate'] = (fvalidate.user_star_level_count_istrade.astype('float') + 0.00001) / (fvalidate.user_star_level_count.astype('float') + 0.001)
    ...
    fvalidate['item_pv_level_count_istrade_rate'] = (fvalidate.item_pv_level_count_istrade.astype('float') + 0.00001) / (fvalidate.item_pv_level_count.astype('float') + 0.001)
    ...
    fvalidate['shop_review_num_level_count_istrade_rate'] = (fvalidate.shop_review_num_level_count_istrade.astype('float') + 0.00001) / (fvalidate.shop_review_num_level_count.astype('float') + 0.001)
    ...
    fvalidate['item_price_level_count_istrade_rate'] = (fvalidate.item_price_level_count_istrade.astype('float') + 0.00001) / (fvalidate.item_price_level_count.astype('float') + 0.001)
    # #  贝叶斯平滑
...
def get_validate_label(fvalidate, validate_label_range):
    ...
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        fvalidate['context_timestamp_user_item_rank_label'] = rank
    else:
        # user和item的context_stamp的排名(升序)
        fvalidate['context_timestamp_user_item_rank_label'] = fvalidate.groupby(['user_id', 'item_id'])['context_timestamp'].rank(ascending=True)
        fvalidate.drop_duplicates(inplace=True)
        pickle.dump(fvalidate['context_timestamp_user_item_rank_label'], open(path, 'wb'))
    i += 1
    path = '../rank_data/valfile' + str(i) + '.pkl'
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        fvalidate['context_timestamp_user_item_rank_label_desc'] = rank
    else:
        # user和item的context_stamp的排名(降序)
        fvalidate['context_timestamp_user_item_rank_label_desc'] = fvalidate.groupby(['user_id', 'item_id'])['context_timestamp'].rank(ascending=False)
        fvalidate.drop_duplicates(inplace=True)
        pickle.dump(fvalidate['context_timestamp_user_item_rank_label_desc'], open(path, 'wb'))
    ...
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        fvalidate['context_timestamp_user_shop_rank_label'] = rank
    else:
        # user和shop的context_stamp的排名(升序)
        fvalidate['context_timestamp_user_shop_rank_label'] = fvalidate.groupby(['user_id', 'shop_id'])['context_timestamp'].rank(ascending=True)
        fvalidate.drop_duplicates(inplace=True)
        pickle.dump(fvalidate['context_timestamp_user_shop_rank_label'], open(path, 'wb'))
    i += 1
    path = '../rank_data/valfile' + str(i) + '.pkl'
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        fvalidate['context_timestamp_user_shop_rank_label_desc'] = rank
    else:
        # user和shop的context_stamp的排名(降序)
        fvalidate['context_timestamp_user_shop_rank_label_desc'] = fvalidate.groupby(['user_id', 'shop_id'])['context_timestamp'].rank(ascending=False)
        fvalidate.drop_duplicates(inplace=True)
        pickle.dump(fvalidate['context_timestamp_user_shop_rank_label_desc'], open(path, 'wb'))
    ...
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        fvalidate['context_timestamp_rank_label'] = rank
    else:
        # 对同一个用户的时间进行排序(升序)
        fvalidate['context_timestamp_rank_label'] = fvalidate.groupby(['user_id'])['context_timestamp'].rank(ascending=True)
        fvalidate.drop_duplicates(inplace=True)
        pickle.dump(fvalidate['context_timestamp_rank_label'], open(path, 'wb'))
    i += 1
    path = '../rank_data/valfile' + str(i) + '.pkl'
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        fvalidate['context_timestamp_rank_desc_label'] = rank
    else:
        # 对同一个用户的时间进行排序(降序)
        fvalidate['context_timestamp_rank_desc_label'] = fvalidate.groupby(['user_id'])['context_timestamp'].rank(ascending=False)
        fvalidate.drop_duplicates(inplace=True)
        pickle.dump(fvalidate['context_timestamp_rank_desc_label'], open(path, 'wb'))
    ...
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        fvalidate['context_timestamp_shop_rank_label'] = rank
    else:
        # 对同一个shop的时间进行排序(升序)
        fvalidate['context_timestamp_shop_rank_label'] = fvalidate.groupby(['shop_id'])['context_timestamp'].rank(ascending=True)
        fvalidate.drop_duplicates(inplace=True)
        pickle.dump(fvalidate['context_timestamp_shop_rank_label'], open(path, 'wb'))
    i += 1
    path = '../rank_data/valfile' + str(i) + '.pkl'
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        fvalidate['context_timestamp_shop_rank_desc_label'] = rank
    else:
        # 对同一个shop的时间进行排序(降序)
        fvalidate['context_timestamp_shop_rank_desc_label'] = fvalidate.groupby(['shop_id'])['context_timestamp'].rank(ascending=False)
        fvalidate.drop_duplicates(inplace=True)
        pickle.dump(fvalidate['context_timestamp_shop_rank_desc_label'], open(path, 'wb'))
    ...
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        fvalidate['context_timestamp_item_rank_label'] = rank
    else:
        # item的context_stamp的排名(升序)
        fvalidate['context_timestamp_item_rank_label'] = fvalidate.groupby(['item_id'])['context_timestamp'].rank(ascending=True)
        fvalidate.drop_duplicates(inplace=True)
        pickle.dump(fvalidate['context_timestamp_item_rank_label'], open(path, 'wb'))
    i += 1
    path = '../rank_data/valfile' + str(i) + '.pkl'
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        fvalidate['context_timestamp_item_rank_label_desc'] = rank
    else:
        # item的context_stamp的排名(降序)
        fvalidate['context_timestamp_item_rank_label_desc'] = fvalidate.groupby(['item_id'])['context_timestamp'].rank(ascending=False)
        fvalidate.drop_duplicates(inplace=True)
        pickle.dump(fvalidate['context_timestamp_item_rank_label_desc'], open(path, 'wb'))
...
def extract_test_feature(test_feature_range,test_label_range):
    ...
    ftest['user_istrade_rate'] = (ftest['user_count_istrade'].astype('float') + 0.00001) / (ftest['user_count'].astype('float') + 0.001)
    #
    # # # 贝叶斯平滑
    ...
    # 交易率
    ftest['user_item_count_istrade_rate'] = (ftest['user_item_count_istrade'].astype('float') + 0.00001) / (ftest['user_item_count'].astype('float') + 0.001)
    # # # 贝叶斯平滑
    ...
    ftest['item_istrade_rate'] = (ftest.item_count_istrade.astype('float') + 0.00001) / (ftest.item_count.astype('float') + 0.001)
    #
    # # # 贝叶斯平滑
    ...
    ftest['shop_istrade_rate'] = (ftest.shop_count_istrade.astype('float') + 0.00001) / (ftest.shop_count.astype('float') + 0.001)
    #
    # # # 贝叶斯平滑
    ...
    ftest['user_shop_count_istrade_rate'] = (ftest.user_shop_count_istrade.astype('float') + 0.00001) / (ftest.user_shop_count.astype('float') + 0.001)
    #
    # # # 贝叶斯平滑
    ...
    ftest['user_shop_item_count_istrade_rate'] = (ftest.user_shop_item_count_istrade.astype('float') + 0.00001) / (ftest.user_shop_item_count.astype('float') + 0.001)
    # # # 贝叶斯平滑
    ...
    ftest['user_item_item_city_id_count_istrade_rate'] = (ftest.user_item_item_city_id_count_istrade.astype('float') + 0.00001) / (ftest.user_item_item_city_id_count.astype('float') + 0.001)
    # #  贝叶斯平滑
    ...
    ftest['user_category_count_istrade_rate'] = (ftest.user_category_count_istrade.astype('float') + 0.00001) / (ftest.user_category_count.astype('float') + 0.001)
    # #  贝叶斯平滑
    ...
    ftest['user_gender_id_count_istrade_rate'] = (ftest.user_gender_id_count_istrade.astype('float') + 0.00001) / (ftest.user_gender_id_count.astype('float') + 0.001)
    ...
    ftest['user_occupation_id_count_istrade_rate'] = (ftest.user_occupation_id_count_istrade.astype('float') + 0.00001) / (ftest.user_occupation_id_count.astype('float') + 0.001)
    ...
    ftest['user_age_level_count_istrade_rate'] = (ftest.user_age_level_count_istrade.astype('float') + 0.00001) / (ftest.user_age_level_count.astype('float') + 0.001)
    ...
    ftest['item_sales_level_count_istrade_rate'] = (ftest.item_sales_level_count_istrade.astype('float') + 0.00001) / (ftest.item_sales_level_count.astype('float') + 0.001)
    ...
    ftest['item_collected_level_count_istrade_rate'] = (ftest.item_collected_level_count_istrade.astype('float') + 0.00001) / (ftest.item_collected_count.astype('float') + 0.001)
    ...
    ftest['user_star_level_count_istrade_rate'] = (ftest.user_star_level_count_istrade.astype('float') + 0.00001) / (ftest.user_star_level_count.astype('float') + 0.001)
    ...
    ftest['item_pv_level_count_istrade_rate'] = (ftest.item_pv_level_count_istrade.astype('float') + 0.00001) / (ftest.item_pv_level_count.astype('float') + 0.001)
    ...
    ftest['shop_review_num_level_count_istrade_rate'] = (ftest.shop_review_num_level_count_istrade.astype('float') + 0.00001) / (ftest.shop_review_num_level_count.astype('float') + 0.001)
    ...
    ftest['item_price_level_count_istrade_rate'] = (ftest.item_price_level_count_istrade.astype('float') + 0.00001) / (ftest.item_price_level_count.astype('float') + 0.001)
    # #  贝叶斯平滑
...
def get_test_label(ftest, test_label_range):
    ...
    i += 1
    path = '../rank_data/testfile' + str(i) + '.pkl'
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        ftest['context_timestamp_user_item_rank_label'] = rank
    else:
        # user和item的context_stamp的排名(升序)
        ftest['context_timestamp_user_item_rank_label'] = ftest.groupby(['user_id', 'item_id'])['context_timestamp'].rank(ascending=True)
        ftest.drop_duplicates(inplace=True)
        pickle.dump(ftest['context_timestamp_user_item_rank_label'], open(path, 'wb'))
    i += 1
    path = '../rank_data/testfile' + str(i) + '.pkl'
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        ftest['context_timestamp_user_item_rank_label_desc'] = rank
    else:
        # user和item的context_stamp的排名(降序)
        ftest['context_timestamp_user_item_rank_label_desc'] = ftest.groupby(['user_id', 'item_id'])['context_timestamp'].rank(ascending=False)
        ftest.drop_duplicates(inplace=True)
        pickle.dump(ftest['context_timestamp_user_item_rank_label_desc'], open(path, 'wb'))
    ...
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        ftest['context_timestamp_user_shop_rank_label'] = rank
    else:
        # user和shop的context_stamp的排名(升序)
        ftest['context_timestamp_user_shop_rank_label'] = ftest.groupby(['user_id', 'shop_id'])['context_timestamp'].rank(ascending=True)
        ftest.drop_duplicates(inplace=True)
        pickle.dump(ftest['context_timestamp_user_shop_rank_label'], open(path, 'wb'))
    i += 1
    path = '../rank_data/testfile' + str(i) + '.pkl'
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        ftest['context_timestamp_user_shop_rank_label_desc'] = rank
    else:
        # user和shop的context_stamp的排名(降序)
        ftest['context_timestamp_user_shop_rank_label_desc'] = ftest.groupby(['user_id', 'shop_id'])['context_timestamp'].rank(ascending=False)
        ftest.drop_duplicates(inplace=True)
        pickle.dump(ftest['context_timestamp_user_shop_rank_label_desc'], open(path, 'wb'))
    ...
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        ftest['context_timestamp_rank_label'] = rank
    else:
        # 对同一个用户的时间进行排序(升序)
        ftest['context_timestamp_rank_label'] = ftest.groupby(['user_id'])['context_timestamp'].rank(ascending=True)
        ftest.drop_duplicates(inplace=True)
        pickle.dump(ftest['context_timestamp_rank_label'], open(path, 'wb'))
    i += 1
    path = '../rank_data/testfile' + str(i) + '.pkl'
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        ftest['context_timestamp_rank_desc_label'] = rank
    else:
        # 对同一个用户的时间进行排序(降序)
        ftest['context_timestamp_rank_desc_label'] = ftest.groupby(['user_id'])['context_timestamp'].rank(ascending=False)
        ftest.drop_duplicates(inplace=True)
        pickle.dump(ftest['context_timestamp_rank_desc_label'], open(path, 'wb'))
    ...
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        ftest['context_timestamp_shop_rank_label'] = rank
    else:
        # 对同一个shop的时间进行排序(升序)
        ftest['context_timestamp_shop_rank_label'] = ftest.groupby(['shop_id'])['context_timestamp'].rank(ascending=True)
        ftest.drop_duplicates(inplace=True)
        pickle.dump(ftest['context_timestamp_shop_rank_label'], open(path, 'wb'))
    i += 1
    path = '../rank_data/testfile' + str(i) + '.pkl'
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        ftest['context_timestamp_shop_rank_desc_label'] = rank
    else:
        # 对同一个shop的时间进行排序(降序)
        ftest['context_timestamp_shop_rank_desc_label'] = ftest.groupby(['shop_id'])['context_timestamp'].rank(ascending=False)
        ftest.drop_duplicates(inplace=True)
        pickle.dump(ftest['context_timestamp_shop_rank_desc_label'], open(path, 'wb'))
    ...
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        ftest['context_timestamp_item_rank_label'] = rank
    else:
        # item的context_stamp的排名(升序)
        ftest['context_timestamp_item_rank_label'] = ftest.groupby(['item_id'])['context_timestamp'].rank(ascending=True)
        ftest.drop_duplicates(inplace=True)
        pickle.dump(ftest['context_timestamp_item_rank_label'], open(path, 'wb'))
    i += 1
    path = '../rank_data/testfile' + str(i) + '.pkl'
    if os.path.exists(path):
        rank = pickle.load(open(path, 'rb'))
        ftest['context_timestamp_item_rank_label_desc'] = rank
    else:
        # item的context_stamp的排名(降序)
        ftest['context_timestamp_item_rank_label_desc'] = ftest.groupby(['item_id'])['context_timestamp'].rank(ascending=False)
        ftest.drop_duplicates(inplace=True)
        pickle.dump(ftest['context_timestamp_item_rank_label_desc'], open(path, 'wb'))
...
def main():
    ...
    # tr5 = pool.submit(extract_train_feature, (train_feature_range5), (train_label_range5), ('five'))
    #
    ...
    train1 = extract_train_feature(train_feature_range1,train_label_range1,'one')
    train2 = extract_train_feature(train_feature_range2,train_label_range2,'two')
    train3 = extract_train_feature(train_feature_range3,train_label_range3,'three')
    train4 = extract_train_feature(train_feature_range4,train_label_range4,'four')
    train5 = extract_train_feature(train_feature_range5,train_label_range5,'five')
    train6 = extract_train_feature(train_feature_range6,train_label_range6,'six')
    train7 = extract_train_feature(train_feature_range7,train_label_range7,'seven')
    train8 = extract_train_feature(train_feature_range8,train_label_range8, 'eight')
    train9 = extract_train_feature(train_feature_range9, train_label_range9, 'nine')

    val = extract_validate_feature(validate_feature_range,validate_label_range)
    test = extract_test_feature(test_feature_range,test_label_range)

    ftrain = pd.concat([train1, train2, train3, train4,train5,train6,train7,train8,train9], axis=0)

    ftrain.to_csv('../data/ftrain.csv', index=None)
    val.to_csv('../data/fvalidate.csv', index=None)
