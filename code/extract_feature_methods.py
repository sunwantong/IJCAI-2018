...
def load_csv():
    ...
    train_feature_range_click_imp_and_rate, train_feature_range_click_imp, train_label_range = data_partition(dframe,dframe_test)

    return train_feature_range_click_imp_and_rate,train_feature_range_click_imp,train_label_range
...
def data_partition(dframe,dframe_test):
    ...
    # feature_range2
    train_feature_range_click_imp = dframe[(dframe['context_timestamp'] >= '20180906000000') &
...
def split_train_test(label):
    ...
    del ftest['is_trade']
    ftest.to_csv('../data/ftest_oneday_maxminscalar.csv', index=None)
    ftrain.to_csv('../data/ftrain_oneday_maxminscalar.csv', index=None)
...
def main():
    train_feature_range_click_imp_and_rate, \
    train_feature_range_click_imp, \
    train_label_range = load_csv()

    ftrain = day31today5_click_imp_and_rate(train_feature_range_click_imp_and_rate,train_label_range,'day31-05')

    ftrain = day06_click_imp(train_feature_range_click_imp,ftrain,'day06')
