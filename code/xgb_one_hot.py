...
def xgb_model_val():
    ...
    train_x = train_set.drop(['instance_id','context_id','item_city_id','item_id','user_id','item_brand_id','shop_id','user_gender_id','user_occupation_id',
                              'is_trade','context_timestamp','context_page_id','context_timestamp_and_dates','dates','day','hour','item_category_list',
                              'item_property_list','predict_category_property','is_first_get_coupon','context_timestamp_rank_desc_label','category',

                              'user_shop_count_istrade_rate', 'user_item_brand_count','user_istrade_rate','user_diff_shop_count',
                              'user_count_minus_user_count_istrade','user_item_count_minus_user_item_istrade',
                              'user_count_istrade','user_and_user_occupation_count_label','predict_property_jiaoji_item_property',
                              'user_shop_count_minus_user_shop_istrade'],axis=1)
...
def xgb_model_test():
    ...
    train_x = train_set.drop(['instance_id','context_id','item_city_id','item_id','user_id','item_brand_id','shop_id','user_gender_id',
    ...
    test_x = test_set.drop(['instance_id','context_id','item_city_id','item_id','user_id','item_brand_id','shop_id','user_gender_id',
                            'context_timestamp','context_timestamp_and_dates','dates','day','hour','item_category_list',
...
def gene_result(pred_value,test_range):
    ...
    res.to_csv("submit/result_one_hot.submit", index=None,sep=' ',line_terminator='\r')
