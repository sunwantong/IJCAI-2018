...
def load_data_one():
    ...
    dframe['l'] = dframe.index
    dframe_test['l'] = dframe_test.index
...
def main():
    ...
    ftrain.set_index(['l'], inplace=True)
    validate.set_index(['l'], inplace=True)
    test.set_index(['l'], inplace=True)

    ftrain.to_csv('data/ftrain.csv')
    validate.to_csv('data/fvalidate.csv')
    test.to_csv('data/ftest.csv')
