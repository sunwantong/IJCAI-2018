...
def new_split_data():
    ...
    dframe_test = pd.read_csv('data/test.csv', sep=",")
...
def load_data_one():
    ...
    #### one-hot
    dframe['user_age_levels'] = dframe['user_age_level']
    dframe['user_star_levels'] = dframe['user_star_level']
    dframe['user_occupation_ids'] = dframe['user_occupation_id']

    dframe = pd.get_dummies(dframe, columns=['user_age_levels'], prefix='user_age', prefix_sep='_')
    dframe = pd.get_dummies(dframe, columns=['user_occupation_ids'], prefix='user_occupation', prefix_sep='_')
    dframe = pd.get_dummies(dframe, columns=['user_star_levels'], prefix='user_star', prefix_sep='_')

    ####dframe_test
    dframe_test['user_age_levels'] = dframe_test['user_age_level']
    dframe_test['user_star_levels'] = dframe_test['user_star_level']
    dframe_test['user_occupation_ids'] = dframe_test['user_occupation_id']

    dframe_test = pd.get_dummies(dframe_test, columns=['user_age_levels'], prefix='user_age', prefix_sep='_')
    dframe_test = pd.get_dummies(dframe_test, columns=['user_occupation_ids'], prefix='user_occupation', prefix_sep='_')
    dframe_test = pd.get_dummies(dframe_test, columns=['user_star_levels'], prefix='user_star', prefix_sep='_')
...
def get_train_label(ftrain, train_label_range):
    ...
    del ftrain['user_age_level']
    del ftrain['user_star_level']
    del ftrain['user_occupation_id']
...
def get_validate_label(fvalidate, validate_label_range):
    ...
    del fvalidate['user_age_level']
    del fvalidate['user_star_level']
    del fvalidate['user_occupation_id']
...
def get_test_label(ftest, test_label_range):
    ...
    del ftest['user_age_level']
    del ftest['user_star_level']
    del ftest['user_occupation_id']
